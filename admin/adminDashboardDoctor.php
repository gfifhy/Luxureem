  ...
  <div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-black-1000 border-dashed rounded-lg dark:border-gray-700">
      ...
      <div class="flex flex-col items-start justify-center h-48 mb-4 p-4 rounded bg-gray-50 dark:bg-gray-800">
        <h2 class="text-2xl font-semibold mb-4">Deleting Doctors</h2>
        <form action="" method="post">
          <label for="userid">Enter User ID to Delete:</label>
          <input type="text" id="userid" name="userid">
          <input name="delete" type="submit" value="Delete"
            style="color: red; border: 1px solid red; padding: .5rem; border-radius: 3px; transition: background-color 0.3s;"
