...
<body style="background-color: #c9a489;">
  ...
  <section class="background-color: #c9a489; dark:bg-gray-900">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
      <div class="font-light text-white sm:text-lg dark:text-gray-400">
        <h2 class="mb-4 text-5xl tracking-tight font-extrabold text-white font-serif">
      ...
      <div class="grid grid-cols-2 gap-4 mt-8">
        <img class="w-64 rounded-lg" src="../imgaboutus/<?= $_SESSION['sec1pic1'] ?>" alt="office content 1" />
        <img class="mt-4 w-64 lg:mt-10 rounded-lg" src="../imgaboutus/<?= $_SESSION['sec1pic2'] ?>"
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white font-serif">
          <?php echo $_SESSION['sec2label1'] ?>
        </h2>
      </div>

      <div class="space-y-8 md:grid lg:grid-cols-3 md:gap-12 md:space-y-0">
        <div class="col-span-1">
          <div>
            <div
              class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            </div>
            <h3 class="mb-2 text-2xl font-bold dark:text-white font-serif">
              <?php echo $_SESSION['sec2sublabel1'] ?>
            </h3>
          ...
          <div>
            ...
            <h3 class="mb-2 text-2xl font-bold dark:text-white font-serif">
              <?php echo $_SESSION['sec2sublabel2'] ?>
            </h3>
            <p class="text-gray-500 dark:text-gray-400 text-lg font-serif">
        ...
        <div class="col-span-1">
          ...
          <div>
            ...
            <h3 class="mb-2 text-2xl font-bold dark:text-white font-serif">
              <?php echo $_SESSION['sec2sublabel4'] ?>
            </h3>
            <p class="text-gray-500 dark:text-gray-400 text-lg font-serif">
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
      <img class="w-full dark:hidden" src="../imgaboutus/<?= $_SESSION['sec2pic2'] ?>" alt="dashboard image" />
      <div>
        <div class="mt-4 md:mt-0">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white font-serif">
            <?php echo $_SESSION['sec2label2'] ?>
          </h2>
          <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400 font-serif">
