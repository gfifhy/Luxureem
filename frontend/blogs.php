    ...
    if ($result->num_rows > 0) {
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          <img class="w-full dark:hidden" src="../profileauthor/<?= $row['blogpic'] ?>" alt="dashboard image" />
          <div>
            ...
            <div class="flex items-center gap-4">
              <img class="w-10 h-10 rounded-full" src="../profileauthor/<?= $row['blogauthorpic'] ?>" />
              <div class="font-medium dark:text-white">
                <div>
                  <?php echo $row['blogauthor']; ?>
                </div>
                <div class="text-sm text-gray-500 dark:text-gray-400">
                  <?php echo "Joined in " . $row['blogdate']; ?>
                </div>
              </div>
              <a href="https://<?php echo $row['bloglink']; ?>" target="_blank"
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="p-5">
                ...
                <div class="flex items-center gap-4">
                  <img class="w-10 h-10 rounded-full" src="../profileauthor/<?= $row['blogauthorpic'] ?>" alt="" />
